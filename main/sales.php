                        ...
                        <ul class="nav nav-list">
                            ...
                            <li>
                                <div class="hero-unit-clock">
                                    ...
                                    <form name="clock">
                                        <h1 font color="white">Time: <br></h1>&nbsp;<input style="width:150px;" type="text" class="trans" name="face" value="" disabled>
                                    </form>
                                </div>
                            </li>
                            ...
                            <tr class="record">
                                ...
                                <td width="90">
                                    <?php if (isset($row['product_id'])): ?>
                                        <a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty']; ?>&code=<?php echo $row['product_id']; ?>" onclick="return confirm('Are you sure you want to cancel this item?')">
